...
## Ownership — clarified 2026-08-05

> [!key-insight] Confirmed by the user: SBTDWS retains FDC 5, Innovation-piece support role still TBD
> Per the user directly: the original framing on this page **is correct** — SBTDWS still owns FDC 5 (tactical experimentation), which is where Makhlab 1 sits. Falcons Brigade's direct MAKHLAB 1 tasking in [[sources/updated-pg-2030-tasks-aug-2026]] is not a contradiction of that — it describes the operational/fielded capability Falcons Brigade will run, not a transfer of the experimentation lead away from J3 WDC/SBTDWS.
>
> What is still genuinely open: **how SBTDWS supports the wider Innovation Command piece** (i.e. the RIC / PGIC integration described in [[PGIC Concept]] and this same task register's Innovation Command tasks). A meeting is scheduled for the week of **2026-08-11** to decide this. Until then, treat the SBTDWS-to-Innovation-Command support model as undecided — do not assume the full handoff framing in [[PGIC Concept]] is final.
>
> See [[Programme MAKHLAB]] for the full numbered-family context (MAKHLAB 2/3/4/8 mapped to other units) this task register also revealed.
